 ...
 */
public class MyAdapter4 extends RecyclerView.Adapter<MyHolder2>  {
    Context c;
    ArrayList<Player2> players,filterList;

    public MyAdapter4(Context ctx, ArrayList<Player2> players)
    {
        this.c=ctx;
    ...
    public void onBindViewHolder(MyHolder2 holder, int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemClick(View v, int pos) {
                switch (pos){
                    case 0:String message9="https://app-1486707345.000webhostapp.com/bhabhijibest.json";
                        Intent in9=new Intent(c,newp.class);
                        in9.putExtra("com.example.dell.manya",message9);
                        c.startActivity(in9);
                        break;
                    case 1:
                        String message10="https://app-1486707345.000webhostapp.com/inspector.json";
                        Intent in10=new Intent(c,newp.class);
                        in10.putExtra("com.example.dell.manya",message10);
                        c.startActivity(in10);
                        break;
                    case 2:
                        String message11="https://app-1486707345.000webhostapp.com/saxena.json";
