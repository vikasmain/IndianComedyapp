...
public class Threefragment2 extends Fragment {
    ...
    private static final String url = "https://felicific-hooks.000webhostapp.com/threes.json";

    private static final String TAG = Threefragment2.class.getSimpleName();
    RequestQueue queue;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //SET ITS PROPETRIES
        list=new ArrayList<>();
        adapter = new MyAdapter4(getActivity(), list);
